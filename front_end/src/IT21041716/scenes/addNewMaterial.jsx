                        ...
                        <form onSubmit={sendData} encType="multipart/form-data" >
                            ...
                            <div className="row gx-3 mb-3">
                                ...
                                <div className="col-md-6">
                                    <label className="small mb-1" for="inputFirstName">Number</label>
                                    <input className="form-control" id="inputFirstName" type="text"  value={number} onChange={(e) => setNumber(e.target.value)} />
                                </div>

                                <div className="col-md-6">
                                    <label className="small mb-1" for="inputLastName">Language</label>
                                    <input className="form-control" id="inputLastName" type="text"  value={language} onChange={(e) => setLanguage(e.target.value)} />
                                </div>
                            </div>
                            <div className="mb-3">
